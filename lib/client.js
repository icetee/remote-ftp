...
// FTP & SFTP modules will only load when actually needed
var	FTP = null, SFTP = null;
	...
	Client.prototype.connect = function (reconnect) {
		...
		switch (self.info.protocol) {
			case 'ftp':
				...
				if (FTP===null) FTP = require('./connectors/ftp');
			...
			case 'sftp':
				...
				if (SFTP===null) SFTP = require('./connectors/sftp');
