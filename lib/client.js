...
module.exports = (function () {
	...
	Client.prototype.connect = function (reconnect) {
		...
		if( self.info.prompt_for_pass === true )
			self.prompt_for_pass( Client.prototype.doConnect );
		else
			Client.prototype.doConnect();
	}
	...
	Client.prototype.prompt_for_pass = function( callback )
	{
		var self = this;
