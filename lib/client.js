...
import os from 'os';
import { File, CompositeDisposable, watchPath } from 'atom';
...
export default (function INIT() {
  class Client extends EventEmitter {
    constructor() {
      ...
      self.watch = {
        ...
        addListeners() {
          ...
          let watchers = [];
          watchDataFormatted.forEach(watchDatum => {
    ...
    connect(reconnect) {
      ...
      if (self.info.keyboardInteractive === true) self.promptForKeyboardInteractive();
      else self.doConnect();
    }
