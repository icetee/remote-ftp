...
module.exports = {
    ...
    protocol: "ftp"                 # string; Supported protocol : ftp, sftp\n\
    host: ""                        # string; Hostname or IP\n\
    port: 21                        # integer; Port\n\
    user: ""                        # string; Username\n\
    pass: ""                        # string; Password\n\
    timeout: 10000                  # integer; Socket timeout\n\
    keepalive: 20000                # integer; Socket keepalive interval\n\
    remote: ""                      # string; Remote directory\n\
    \n\
    secure: false                   # bool or string; true for both control and data connection encryption; "control" for control connection encryption only; "implicit" for implicitly encrypted control connection\n\
    secureOptions: null             # object; See http://nodejs.org/api/tls.html#tls_tls_connect_options_callback\n\
    \n\
    privatekey: ""                  # string or filename; Private key for SFTP\n\
}'          , function (err) {
                if (!err)
