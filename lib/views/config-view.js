      ...
      if(gutter.name == "line-number"){
        ...
        View.$(atom.views.getView(gutter)).mouseover(function(event){
          ...
          if(target.hasClass('ftpconfig-pk-prompt')){
            ...
            var input = '<label class="btn btn-info ftpconfig-input-label a-top-level-element" style="top:' + (event.clientY-20) +'px;left:' + (event.clientX-25) +'px; display:none;">\
      ...
      if(gutter.name == "line-number"){
        View.$(atom.views.getView(gutter)).mouseover(function(event){
          ...
          if(target.hasClass('ftpconfig-watch-prompt')){
            var input = '<div  class="a-top-level-element" style="top:' + (event.clientY-40) +'px;left:' + (event.clientX-50) +'px;display:none;">\
