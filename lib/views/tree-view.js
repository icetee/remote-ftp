...
module.exports = TreeView = (function (parent) {
	...
	TreeView.prototype.initialize = function (state) {
		...
		self.offline.html('<p><a role="connect">Connect</a>, <br><a role="configure">edit configuration</a>, <br><a role="configure_ignored">edit ignored</a> or <br><a role="toggle">close panel<a></p>');
