...
class DirectoryView extends View {
  ...
  initialize(directory) {
    ...
    // Trigger repaint
    this.item.$folders.onValue(() => { this.repaint(); });
    this.item.$files.onValue(() => { this.repaint(); });
    this.item.$isExpanded.onValue(() => { this.setClasses(); });
    this.item.on('destroyed', () => { this.destroy(); });
    this.repaint();
